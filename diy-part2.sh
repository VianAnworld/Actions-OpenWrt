...
mkdir -p feeds/luci/applications/luci-app-openclash/luci-app-openclashroot/etc/openclash/core
mv /tmp/clash feeds/luci/applications/luci-app-openclash/luci-app-openclashroot/etc/openclash/core >/dev/null 2>&1
