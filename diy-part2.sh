...
tar zxvf /tmp/clash.tar.gz -C /tmp >/meta/null 2>&1
chmod +x /tmp/clash >/meta/null 2>&1
mkdir -p feeds/luci/applications/luci-app-openclash/root/etc/openclash/core
mv /tmp/clash feeds/luci/applications/luci-app-openclash/root/etc/openclash/core/clash >/meta/null 2>&1
rm -rf /tmp/clash.tar.gz >/meta/null 2>&1
